...
public class DySmsHelper {
    ...
    public static void sendSms(String phone, JSONObject templateParamJson, DySmsEnum dySmsEnum) throws ClientException {
        //可自助调整超时时间
        ...
        request.setTemplateParam(JSONUtil.toJsonStr(templateParamJson));
        ...
        log.info("Code: {}, Message: {}", sendSmsResponse.getCode(), sendSmsResponse.getMessage());
        log.info("RequestId: {}, BizId: {}", sendSmsResponse.getRequestId(), sendSmsResponse.getBizId());
    }
